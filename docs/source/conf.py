...
extensions = [
    ...
    'sphinx.ext.napoleon',
    'sphinxcontrib_trio',
    # Would like to use this, but it has too many issues currently:
...
latex_documents = [
    (master_doc, 'tricycle.tex', 'tricycle Documentation',
     author, 'manual'),
]
